      ...
      <div className="space-y-8 animate-fade-in-up">
        ...
        <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Métricas consolidadas de visitas, avarias e performance operacional.
            </p>
          </div>
          {isDataEmpty && (
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Chart G: Brindes por Tipo (Horizontal Bar) */}
            <div className="lg:col-span-1 bg-white p-5 border border-slate-200 rounded-2xl shadow-[var(--shadow-soft)] flex flex-col min-h-[340px]">
              ...
              <div className="flex-1 text-xs">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart
                    data={(displayData as any).brindesPorTipoChart}
                    layout="vertical"
                  ...
                  >
                    ...
                    <Bar dataKey="value" radius={[0, 8, 8, 0]} name="Qtd. Solicitada">
                      {((displayData as any).brindesPorTipoChart || []).map((_: any, index: number) => (
            ...
            <div className="bg-white p-5 border border-slate-200 rounded-2xl shadow-[var(--shadow-soft)] flex flex-col min-h-[340px]">
              ...
              <div className="flex-1 text-xs">
                <ResponsiveContainer width="100%" height={200}>
                  <PieChart>
                    <Pie
                      data={(displayData as any).brindesStatusChart}
                      cx="50%"
                      cy="50%"
                      innerRadius={52}
                      outerRadius={76}
                      ...
                      dataKey="value"
                    >
                      {((displayData as any).brindesStatusChart || []).map((entry: any, index: number) => (
              ...
              <div className="flex flex-wrap justify-center gap-x-4 gap-y-1.5 text-[10px] font-bold text-slate-500 pt-2 border-t border-slate-50">
                {((displayData as any).brindesStatusChart || []).map((item: any, idx: number) => (
                  <div key={idx} className="flex items-center gap-1.5">
                    <span className="h-2 w-2 rounded-full" style={{ backgroundColor: item.color }} />
                    <span>{item.name} ({item.value})</span>
                  </div>
            ...
            {/* Chart I: Evolução de Solicitações por Mês (Line) */}
            <div className="bg-white p-5 border border-slate-200 rounded-2xl shadow-[var(--shadow-soft)] flex flex-col min-h-[340px]">
              <div className="mb-4">
              ...
              <div className="flex-1 text-xs">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart
                    data={(displayData as any).brindesPorMesChart}
